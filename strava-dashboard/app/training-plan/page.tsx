    ...
    return (
      <main style={pageStyle}>
        ...
        <div style={{
          ...
          <h2 style={{ color: COLORS.textDark, fontSize: "1.2rem", fontWeight: 700, marginTop: 0, marginBottom: "12px" }}>
            Set Up Your Race Plan
          </h2>
          <p style={{ color: COLORS.textMuted, fontSize: "0.88rem", marginBottom: "24px", lineHeight: 1.6 }}>
            Enter your race details and current fitness. The plan uses 28-week periodization
            with specific long run progression (15→25→35→40km), plateau phase (weeks 20-24),
            recovery every 4 weeks, and a 4-week taper.
          </p>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "12px" }}>
            ...
            <label style={labelStyle}>
              Total Plan Weeks
              <input type="number" value={totalWeeks} onChange={(e) => setTotalWeeks(e.target.value)} style={inputStyle} />
            </label>
            <label style={labelStyle}>
            ...
            <label style={labelStyle}>
              Current Long Run (km)
              <input type="number" value={startingLongRun} onChange={(e) => setStartingLongRun(e.target.value)} style={inputStyle} />
            </label>
            <label style={labelStyle}>
              Target Peak Volume (km)
              <input type="number" value={peakVolume} onChange={(e) => setPeakVolume(e.target.value)} style={inputStyle} />
            </label>
          </div>
  ...
  return (
    <main style={pageStyle}>
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "1.5rem" }}>
        <h1 style={{ fontSize: "1.8rem", fontWeight: 700, color: COLORS.textDark, margin: 0 }}>
          {plan.name}
        </h1>
      ...
      <div style={{
        ...
        <div>
          <span style={{ color: COLORS.textMuted, fontSize: "0.75rem", textTransform: "uppercase", fontWeight: 700, letterSpacing: "0.05em" }}>Race Day</span>
        ...
        <div style={{ textAlign: "right" }}>
          ...
          <div style={{ color: COLORS.textMuted, fontSize: "0.75rem", marginTop: "4px", fontWeight: 600 }}>days to go</div>
        </div>
      </div>
        ...
        <div style={{
          ...
          <div style={{
            ...
            <span style={{ color: COLORS.cardAccent, fontSize: "0.8rem", fontWeight: 600 }}>
              {currentWeek.cycle_number ? `Cycle ${currentWeek.cycle_number}, W${currentWeek.week_in_cycle}` : ""} · {weeksToRace} weeks to race
            </span>
          </div>
          ...
          <div style={{ padding: "18px 20px" }}>
            <div style={{
              ...
              <div style={{
                ...
                <div style={{ color: COLORS.textMuted, fontSize: "0.7rem", textTransform: "uppercase", marginBottom: "6px", fontWeight: 700 }}>Target</div>
                <div style={{ color: COLORS.textDark, fontSize: "1.3rem", fontWeight: 700 }}>{currentWeek.target_volume_km} km</div>
              </div>
              <div style={{
                backgroundColor: COLORS.cardAlt,
                padding: "12px",
                ...
                <div style={{ color: COLORS.textMuted, fontSize: "0.7rem", textTransform: "uppercase", marginBottom: "6px", fontWeight: 700 }}>Actual</div>
                <div style={{
                  color: currentWeek.actualVolumeKm >= currentWeek.target_volume_km ? COLORS.success : COLORS.textDark,
                  fontSize: "1.3rem",
                  fontWeight: 700
                }}>
              ...
              <div style={{
                ...
                <div style={{ color: COLORS.textMuted, fontSize: "0.7rem", textTransform: "uppercase", marginBottom: "6px", fontWeight: 700 }}>Remaining</div>
              ...
              <div style={{
                ...
                <div style={{ color: COLORS.textMuted, fontSize: "0.7rem", textTransform: "uppercase", marginBottom: "6px", fontWeight: 700 }}>Long Run</div>
              ...
              {currentWeek.back_to_back ? (
                <div style={{
                  ...
                  <div style={{ color: COLORS.textMuted, fontSize: "0.7rem", textTransform: "uppercase", marginBottom: "6px", fontWeight: 700 }}>Back-to-Back</div>
            ...
            <div style={{
              ...
              <div style={{
                ...
                height: "100%",
                backgroundColor: currentWeek.actualVolumeKm >= currentWeek.target_volume_km ? COLORS.success : PHASE_COLORS[currentWeek.phase],
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(5, 1fr)", gap: "12px", marginBottom: "1.5rem" }}>
        {[
          ...
          <div key={s.label} style={{
            ...
            <div style={{ color: COLORS.textMuted, fontSize: "0.7rem", textTransform: "uppercase", marginBottom: "6px", fontWeight: 700 }}>{s.label}</div>
      ...
      <div style={{ marginBottom: "1.5rem" }}>
        <h2 style={{ color: COLORS.textDark, fontSize: "1.1rem", fontWeight: 600, marginBottom: "10px" }}>Volume Plan</h2>
        <div style={{
          backgroundColor: COLORS.cardBg,
          borderRadius: "14px",
          padding: "20px",
            ...
            {weeks.map((w, i) => {
              ...
              return (
                <div key={w.week_number} style={{ flex: "0 0 24px", display: "flex", flexDirection: "column", alignItems: "center", gap: "2px", position: "relative" }}>
                  {/* Back-to-back marker */}
                  {w.back_to_back ? (
                    <div style={{ position: "absolute", top: "-16px", fontSize: "0.55rem", color: COLORS.error, fontWeight: 700 }}>B2B</div>
                  ) : null}
                  {/* Target bar (ghost) */}
                  <div style={{
                    position: "absolute",
                  ...
                  {/* Current week marker */}
                  {isCurrent && (
                    <div style={{ position: "absolute", top: w.back_to_back ? "-28px" : "-14px", fontSize: "0.6rem", color: COLORS.primaryGreen, fontWeight: 700 }}>NOW</div>
                  )}
                </div>
              );
            })}
      ...
      {/* Week-by-week table */}
      <div>
        <h2 style={{ color: COLORS.textDark, fontSize: "1.1rem", fontWeight: 600, marginBottom: "10px" }}>Week by Week</h2>
        <div style={{
          backgroundColor: COLORS.cardBg,
          borderRadius: "14px",
          overflow: "hidden",
            ...
            return (
              <div
                ...
                style={{
                  ...
                  gridTemplateColumns: "46px 80px 68px 65px 70px 65px 55px 55px 45px 1fr",
                  padding: "10px 14px",
                  backgroundColor: isCurrent ? `${PHASE_COLORS[w.phase]}15` : (i % 2 === 0 ? COLORS.cardBg : `${COLORS.cardAlt}80`),
              ...
              >
                <span style={{ color: isCurrent ? COLORS.textDark : COLORS.textMuted, fontSize: "0.8rem", fontWeight: isCurrent ? 700 : 500 }}>
                  {w.week_number}
                </span>
                ...
                <span style={{ color: w.long_run_km > 0 ? COLORS.warmGold : COLORS.textLight, fontSize: "0.8rem", fontWeight: w.long_run_km > 0 ? 600 : 400 }}>
                  {w.long_run_km > 0 ? `${w.long_run_km} km` : "—"}
                </span>
                <span style={{ color: w.actualVolumeKm > 0 ? (pct >= 90 ? COLORS.success : COLORS.textDark) : COLORS.textLight, fontSize: "0.8rem", fontWeight: 600 }}>
                  {w.actualVolumeKm > 0 ? `${w.actualVolumeKm} km` : "—"}
                </span>
                <span style={{ color: COLORS.textMuted, fontSize: "0.75rem" }}>{w.runCount > 0 ? w.runCount : "—"}</span>
                <span style={{ color: COLORS.textMuted, fontSize: "0.75rem" }}>{w.gymCount > 0 ? w.gymCount : "—"}</span>
                <span style={{ color: w.back_to_back ? COLORS.error : COLORS.textLight, fontSize: "0.7rem", fontWeight: w.back_to_back ? 700 : 400 }}>
                  {w.back_to_back ? "✓" : "—"}
                </span>
      ...
      <div style={{
        ...
        <div style={{ color: COLORS.textMuted, fontSize: "0.82rem", lineHeight: 1.6 }}>
          <p style={{ margin: "0 0 8px 0" }}>
            <strong style={{ color: COLORS.textDark }}>28-week structure:</strong> 24 weeks build/plateau phase + 4 weeks taper. Recovery weeks at weeks 4, 8, 12, 16, 20.
          </p>
          <p style={{ margin: "0 0 8px 0" }}>
            <strong style={{ color: COLORS.textDark }}>Volume increases:</strong> Progressive build with max 15% increase per week, capped at +5km/week.
          </p>
          <p style={{ margin: "0 0 8px 0" }}>
            <strong style={{ color: COLORS.textDark }}>Long run progression:</strong> Weeks 1-8: 15→25km | Weeks 9-16: 25→35km | Weeks 17-24: 35-40km plateau.
          </p>
          <p style={{ margin: "0 0 8px 0" }}>
            <strong style={{ color: COLORS.textDark }}>Recovery weeks:</strong> 65% of previous week's volume, long run at 50% of previous week.
          </p>
          <p style={{ margin: "0 0 8px 0" }}>
            <strong style={{ color: COLORS.textDark }}>Plateau phase (weeks 20-24):</strong> Hold peak volume with 2-3 back-to-back long run weekends.
          </p>
          <p style={{ margin: 0 }}>
            <strong style={{ color: COLORS.textDark }}>Taper (weeks 25-28):</strong> 70% → 55% → 35% → 20% of peak volume.
          </p>
        </div>
      </div>
    </main>
